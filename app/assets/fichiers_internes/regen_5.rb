...
TARGETS = {
  "lombalgie-chronique" =>
    "A lumbar support cushion and a tube of anti-inflammatory gel on a warm wooden surface, a printed MRI scan slightly blurred in background, soft side light.",
  "schizophrenie" =>
    "A small notebook open to a page of fragmented handwriting, a blister pack of antipsychotic medication, and a quiet corner of a room with soft diffused light.",
  "syndrome-fatigue-chronique" =>
    "An unmade bed with rumpled cream linen sheets in full daylight, a glass of water barely touched on the nightstand, curtains half-open, heavy stillness.",
  "sarcoidose" =>
    "A chest x-ray film held up to soft window light, a small bottle of corticosteroids, and a stethoscope coiled on a cream surface.",
  "fibromyalgie" =>
    "A tube of muscle pain relief gel, two heat patches still in their foil packaging, and a weekly pill organizer on a warm wooden surface, soft morning light."
}.freeze
